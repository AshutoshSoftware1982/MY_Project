...
{
    public partial class Client_Code6 : Form
    {
        public Client_Code6()
        {
            InitializeComponent();
        ...
        private void Client_Code6_Load(object sender, EventArgs e)
        {
            LoadData();
        }
        ...
        {
            StyleContent fr = (StyleContent)Application.OpenForms["StyleContent"];
            int row = e.RowIndex;
